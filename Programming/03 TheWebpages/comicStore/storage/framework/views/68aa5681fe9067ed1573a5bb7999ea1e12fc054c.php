...
<body>
    ...
    <ul class="GNB fixed-top">
        ...
        <ul class="GNA fixed-top">
          <h4 class="small-Title">CATEGORÍAS</h4>
          <li class="GNB_E"><a class="GNB_A" href="#mNew">Más Nuevo</a></li>
          <li class="GNB_E"><a class="GNB_A" href="#mVot">Más Votado</a></li>
          <?php if(!Auth::guest()): ?>
          <li class="GNB_E"><a class="GNB_A" href="/profile/<?php echo e(Auth::user()->id); ?>">Favoritos</a></li>
          <li class="GNB_E"><a class="GNB_A" href="/profile/<?php echo e(Auth::user()->id); ?>">Subscripciones</a></li>
          <?php endif; ?>
        </ul>
        ...
        <div class="fistA album text-muted">
          <div class="objCont">
            ...
            <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="card">
                <a href="/product/"><img class="art_img" alt="100%x280" src="data:image/jpeg;base64, <?php echo e($articles->img1); ?>" data-holder-rendered="true"></a>
                <div class="card-body">
                  <h5 class="card-title">
                    <a class="standard nphl" href="/product/"><?php echo e($articles->name_article); ?></a>
                  </h5>
        ...
        <div class="album text-muted">
          <div class="objCont">
            ...
            <div class="infoProducto">
              <div class="card">
                <a href="/product/"><img class="art_img" alt="100%x280" src="" data-holder-rendered="true"></a>
                <div class="card-body">
                  <h5 class="card-title">
                    <a class="standard nphl" href="/product/">Nombre Artículo</a>
                  </h5>
                  <h6>Precio</h6>
                  <small>rating</small>
                  <i class="fas fa-star"></i>
