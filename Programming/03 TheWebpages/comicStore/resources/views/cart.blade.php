            ...
            <div style="background-color: aliceblue" >
              <table id="mytable" class="table table-bordred table-striped">
                ...
                <tbody>
                  <td>
                    <div>
                      <h6 class="my-0" value="" >{{$cart->name_article}}</h6>
                    </div>
                  </td>
                  <td>
                    <input type="number" name="newUnits" id="" min="1" max="{{$cart->ua}}" value="{{$cart->units}}">
                  </td>
                  <td>
                    <span class="text-muted" >${{$cart->price}}</span> 
                  </td>
                  <td>
                    <a name="Save" class="delfromcart" href="/loadDiscuss/{{$cart->id}}">Discutir<a>
                  </td>
                  @if($cart->price > 0)
                  <td>
                  ...
                  @endif
                  <td>
                    <a name="Save" class="delfromcart" href="/delCart/{{$cart->id}}">X<a>
                  </td>
                </tbody>
                </form>
                  @endforeach
