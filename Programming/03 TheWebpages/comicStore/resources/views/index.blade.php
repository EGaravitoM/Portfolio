    ...
    <ul class="GNB fixed-top">
        ...
        <div class="fistA album text-muted">
          <div class="objCont">
            ...
            @foreach($articles as $articles)
              <div class="card">
                <a href="/product/{{$articles->id}}"><img class="art_img" alt="100%x280" src="data:image/jpeg;base64, {{$articles->img1}}" data-holder-rendered="true"></a>
                <div class="card-body">
                  <h5 class="card-title">
                    <a class="standard nphl" href="/product/{{$articles->id}}">{{$articles->name_article}}</a>
                  </h5>
                  <h6>${{$articles->price}}</h6>
                  <small>Rating: {{$articles->rating}}</small>
        ...
        <div class="album text-muted">
          <div class="objCont">
            ...
            <div class="infoProducto">
            @foreach($votos as $votos)
              <div class="card">
                <a href="/product/{{$votos->id}}"><img class="art_img" alt="100%x280" src="data:image/jpeg;base64, {{$votos->img1}}" data-holder-rendered="true"></a>
                <div class="card-body">
                  <h5 class="card-title">
                    <a class="standard nphl" href="/product/{{$votos->id}}">{{$votos->name_article}}</a>
                  </h5>
                  <h6>${{$votos->price}}</h6>
                  <small>Rating: {{$votos->rating}}</small>
                  <i class="fas fa-star"></i>
                </div>
              </div>
              @endforeach
        ...
        <div class="album text-muted">
          <div class="objCont">
            ...
            <div class="infoProducto">
            @foreach($masCaros as $masCaros)
              <div class="card">
                <a href="/product/{{$masCaros->id}}"><img class="art_img" alt="100%x280" src="data:image/jpeg;base64, {{$masCaros->img1}}" data-holder-rendered="true"></a>
                <div class="card-body">
                  <h5 class="card-title">
                    <a class="standard nphl" href="/product/{{$masCaros->id}}">{{$masCaros->name_article}}</a>
                  </h5>
                  <h6>${{$masCaros->price}}</h6>
                  <small>Rating: {{$masCaros->rating}}</small>
                  <i class="fas fa-star"></i>
                </div>
              </div>
              @endforeach
        ...
        <div class="album text-muted">
          <div class="objCont">
            ...
            <div class="infoProducto">
            @foreach($masBaratos as $masBaratos)
              <div class="card">
                <a href="/product/{{$masBaratos->id}}"><img class="art_img" alt="100%x280" src="data:image/jpeg;base64, {{$masBaratos->img1}}" data-holder-rendered="true"></a>
                <div class="card-body">
                  <h5 class="card-title">
                    <a class="standard nphl" href="/product/{{$masBaratos->id}}">{{$masBaratos->name_article}}</a>
                  </h5>
                  <h6>${{$masBaratos->price}}</h6>
                  <small>Rating: {{$masBaratos->rating}}</small>
                  <i class="fas fa-star"></i>
                </div>
              </div>
              @endforeach
