...
<body style="padding-left: 5%; padding-top: 50px">
    ...
    <div class="container">
        ...
        <form action="/makeEdit/{{$article->id}}" method="post" enctype="multipart/form-data">
            @csrf

                <div class="form-group">
                    <label for="itemname">Nombre</label>
                    <input type="text" class="form-control" name="name_article" id="itemname" value="{{$article->name_article}}" required />
                    <small id="itemnameHelp" class="form-text text-muted">Nombre del Artículo</small>
                </div>
                <div class="form-group">
                    <label for="descripcion">Descripción</label>
                    <textarea style="font-color=black" value="" name="description_article" id="descripcion" cols="75" rows="10">{{$article->description_article}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1" name="price" class="form-control" id="price" value="{{$article->price}}" required>
                    <small id="priceHelp" class="form-text text-muted">Costo del producto.</small>
                </div>
                <div class="form-group">
                    <label for="units">Unidades</label>
                    <input type="number" min="1" name="units" value="{{$article->units}}" class="form-control" id="units" required>
